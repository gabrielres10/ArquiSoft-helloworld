...
{
    default void callback(String msg)
    {
        callback(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void callback(String msg, java.util.Map<String, String> context)
    {
        _iceI_callbackAsync(msg, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> callbackAsync(String msg)
    {
        return _iceI_callbackAsync(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> callbackAsync(String msg, java.util.Map<String, String> context)
    {
        return _iceI_callbackAsync(msg, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_callbackAsync(String iceP_msg, java.util.Map<String, String> context, boolean sync)
    {
